def print_args(args):
    ...
    # ============================================
    # DualMAE4TS Core Parameters
    # ============================================
    if args.model == 'DualMAE4TS':
        print("\033[1m" + "DualMAE4TS Parameters" + "\033[0m")
        ...
        print(f'  {"LoRA Rank (r):":<20}{args.r:<20}{"LoRA Alpha:":<20}{args.lora_alpha:<20}')
        print(f'  {"LoRA Dropout:":<20}{args.lora_dropout:<20}{"Residual Weight:":<20}{args.residual_weight:<20}')
        print(f'  {"Use Norm:":<20}{args.use_norm:<20}{"VM Arch:":<20}{args.vm_arch:<20}')
